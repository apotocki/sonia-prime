...
class array_elements_implicit_cast_pattern : public functional::pattern
{
public:
    array_elements_implicit_cast_pattern() = default;
    ...
    std::ostream& print(unit const&, std::ostream& s) const override { return s << "implicit_cast(array(element=($e), size))->vector(element $e)"sv; }
};
