...
struct expression_cast_to_float_visitor : static_visitor<std::expected<bang_type, error_storage>>
{
    ...
    */
    ...
    {
        return std::unexpected(make_error<cast_error>(cl_(), bang_float_t{}, v));
    }
};
