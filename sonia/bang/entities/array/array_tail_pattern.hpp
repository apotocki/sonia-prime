...
class array_tail_pattern : public functional::pattern
{
public:
    array_tail_pattern() = default;
    ...
    std::ostream& print(unit const&, std::ostream& s) const override { return s << "tail(:array(of $E, size $S)) ~> array(of: $E, size: $S-1)"sv; }
};
