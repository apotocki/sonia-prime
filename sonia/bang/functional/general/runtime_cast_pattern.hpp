...
class runtime_cast_pattern : public functional::pattern
{
public:
    runtime_cast_pattern() = default;
    ...
    std::ostream& print(unit const&, std::ostream& s) const override { return s << "runtime_cast(_)->$R"; }
};
