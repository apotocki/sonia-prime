...
class tuple_set_pattern : public functional::pattern
{
public:
    tuple_set_pattern() = default;
    ...
    std::ostream& print(unit const&, std::ostream& s) const override { return s << "tuple.set"; }
};
