...
#ifndef AGNOSTIC_STD_ITERATOR_TRAITS_HPP
#define AGNOSTIC_STD_ITERATOR_TRAITS_HPP
...
template <class IterT> struct iterator_traits : iterator_traits_impl<IterT> {};
...
#endif // AGNOSTIC_STD_ITERATOR_TRAITS_HPP
