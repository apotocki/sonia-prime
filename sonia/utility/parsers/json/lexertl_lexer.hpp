...
{
protected:
    typedef lexertl_lexer_base lexertl_lexer_base_t;
...
public:
    ...
    static void build_string_rules(RulesT & rules) {
        ...
        rules.push("[A-Z_a-z\\x23-\\x25\\x7f-\\xff]([0-9A-Z_a-z\\x23-\\x25\\x7f-\\xff]|\\x5c[bfnrt\\x22\\x27\\x3b\\x5c\\x2f]|\\x5cu(\\d|[a-f]|[A-F]){4})*", ID_NAME);
    }
};
