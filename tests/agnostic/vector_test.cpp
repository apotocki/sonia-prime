...
/*
#define DO_NOT_USE_AGNOSTIC_IS_OBJECT
#define DO_NOT_USE_AGNOSTIC_IS_BASE_OF
#define DO_NOT_USE_AGNOSTIC_MOVE_CONSTRUCTIBLE_CONCEPT
#define DO_NOT_USE_AGNOSTIC_COMMON_REFERENCE_WITH_CONCEPT
#define DO_NOT_USE_AGNOSTIC_ASSIGNABLE_FROM_CONCEPT
#define DO_NOT_USE_AGNOSTIC_SWAPPABLE_CONCEPT
#define DO_NOT_USE_AGNOSTIC_MOVABLE_CONCEPT
#define DO_NOT_USE_AGNOSTIC_WEAKLY_INCREMENTABLE_CONCEPT
#define DO_NOT_USE_AGNOSTIC_INPUT_OR_OUTPUT_ITERATOR_CONCEPT
#define DO_NOT_USE_AGNOSTIC_INPUT_ITERATOR_CONCEPT
#define DO_NOT_USE_AGNOSTIC_FORWARD_ITERATOR_CONCEPT
#define DO_NOT_USE_AGNOSTIC_BIDIRECTIONAL_ITERATOR_CONCEPT
//#define DO_NOT_USE_AGNOSTIC_RANDOM_ACCESS_ITERATOR_CONCEPT
#define DO_NOT_USE_AGNOSTIC_IS_LVALUE_REFERENCE
#define DO_NOT_USE_AGNOSTIC_REMOVE_EXTENT_HPP
#define DO_NOT_USE_AGNOSTIC_ADD_POINTER
#define DO_NOT_USE_AGNOSTIC_DECAY
#define DO_NOT_USE_AGNOSTIC_COMMON_TYPE
#define DO_NOT_USE_AGNOSTIC_COMMON_REFERENCE
#define DO_NOT_USE_AGNOSTIC_RANGES_SWAP
*/
/*
