...
struct expression_cast_to_vector_visitor : static_visitor<std::expected<bang_type, error_storage>>
{
    fn_compiler_context& ctx;
    bang_vector_t const& target;
    context_locator_t cl_;

    expression_cast_to_vector_visitor(fn_compiler_context& c, bang_vector_t const& t, context_locator_t const& cl)
        : ctx{ c }
        , target{ t }
        , cl_{ cl }
    {}
