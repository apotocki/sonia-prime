...
class vector_make_pattern : public functional::pattern
{
public:
    vector_make_pattern() = default;
    ...
    std::ostream& print(unit const&, std::ostream& s) const override { return s << "make_vector(of $T: typename, ~ $T ...) ~> vector(of: $T)"sv; }
