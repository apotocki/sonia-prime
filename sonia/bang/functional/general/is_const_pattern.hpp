...
class is_const_pattern : public functional::pattern
{
public:
    is_const_pattern() = default;
    ...
    std::ostream& print(unit const&, std::ostream& s) const override { return s << "is_const(_)->bool"; }
};
