...
error_storage metaobject_bit_and_pattern::accept_argument(std::nullptr_t, functional_match_descriptor_ptr& pmd, arg_context_type& argctx, semantic::managed_expression_list&) const
{
    return argctx.make_argument_mismatch_error();
}

error_storage metaobject_bit_and_pattern::accept_argument(std::nullptr_t, functional_match_descriptor_ptr& pmd, arg_context_type& argctx, entity_identifier& eid) const
{
