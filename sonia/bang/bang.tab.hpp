  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_field = 138,                           // field
        S_139_field_type_expr = 139,             // field-type-expr
        ...
        S_157_compound_expression = 157,         // compound-expression
        S_158_type_expr = 158                    // type-expr
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 882,     ///< Last index in yytable_.
