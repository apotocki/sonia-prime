...
class metaobject_pattern : public functional::pattern
{
public:
    metaobject_pattern() = default;
    ...
    std::ostream& print(unit const&, std::ostream& s) const override { return s << "metaobject(...)"sv; }
};
