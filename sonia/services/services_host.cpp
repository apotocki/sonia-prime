...
void host_impl::register_multimethod(multimethod && mm, type_info const& id, array_view<const type_info> mmid) {
...
multimethod const* host_impl::get_multimethod(type_info const& id) const {
