...
class struct_implicit_cast_pattern : public functional::pattern
{
public:
    struct_implicit_cast_pattern() = default;
    ...
    std::ostream& print(unit const&, std::ostream& s) const override { return s << "implicy_cast(@structure)"sv; }
};
