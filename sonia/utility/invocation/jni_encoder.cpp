...
jobject jni_encoder::encode(JNIEnv* penv, blob_result const& b) const
{
    ...
    case blob_type::boolean:
        return env.new_boxed_value<jboolean>((jint)b.bp.i8value).detach();
    case blob_type::i8:
        return env.new_boxed_value<jbyte>((jbyte)b.bp.i8value).detach();
    case blob_type::ui8:
        return env.new_boxed_value<jshort>((jshort)b.bp.ui8value).detach();
    case blob_type::i16:
        return env.new_boxed_value<jshort>((jshort)b.bp.i16value).detach();
    case blob_type::ui16:
        return env.new_boxed_value<jint>((jint)b.bp.ui16value).detach();
    case blob_type::i32:
        return env.new_boxed_value<jint>((jint)b.bp.i32value).detach();
    case blob_type::ui32:
        return env.new_boxed_value<jlong>((jlong)b.bp.i32value).detach();
    case blob_type::i64:
        return env.new_boxed_value<jlong>((jlong)b.bp.i64value).detach();
    case blob_type::ui64:
        return env.new_boxed_value<jlong>((jlong)b.bp.ui64value).detach();
    case blob_type::flt16:
        return env.new_boxed_value<jfloat>((jfloat)b.bp.f16value).detach();
    case blob_type::flt32:
        return env.new_boxed_value<jfloat>((jfloat)b.bp.f32value).detach();
    case blob_type::flt64:
        return env.new_boxed_value<jdouble>((jdouble)b.bp.f64value).detach();
