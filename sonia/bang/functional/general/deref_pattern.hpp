...
class deref_pattern : public functional::pattern
{
public:
    deref_pattern() = default;
    ...
    std::ostream& print(unit const&, std::ostream& s) const override { return s << "deref(const __qname)->?"; }
};
