...
private:
        ...
        , enable_shared_from_this<connection_cache>
    {
        ...
        std::pair<io::tcp_socket, size_t> tcp_socket_accept(tcp_handle_type, char*, size_t) override;
        ...
        void close_handle(identity<io::tcp_socket_service_type>, tcp_handle_type) noexcept override;
        void release_handle(identity<io::tcp_socket_service_type>, tcp_handle_type h) noexcept;
        void free_handle(identity<io::tcp_socket_service_type>, tcp_handle_type) noexcept override;
